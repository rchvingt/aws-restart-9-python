"""
create the main program that parses the JSON data and calculates the molecular weight
"""
import jsonFileHandler

data = jsonFileHandler.readJsonFile("/home/ec2-user/environment/fileHandle/insulin.json")
